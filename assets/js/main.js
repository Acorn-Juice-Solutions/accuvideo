(function () {
  ...
  const i18n = {
    en: {
      ...
      'pricing.subscribe.step1': 'Install AccuVideo and launch it. On first launch the app asks for your license — if you don\'t have one yet, use the in-app buttons to request a <strong>free trial</strong> or a <strong>paid subscription</strong>. No hardware ID to copy, no menus to hunt through.',
      'pricing.subscribe.step2': 'Click <strong>Request subscription</strong> in the app, or use the <a href="#" data-open-form="subscribe">subscription form</a> here. Pick your <strong>plan</strong>, <strong>edition</strong> and <strong>billing period</strong> (monthly / annual) and we send you to Stripe checkout. Once payment clears, we email you your license the first time — you apply it in the app under <strong>Settings</strong>. From then on, the license stays valid on that machine as long as your subscription payment remains confirmed.',
      ...
      'download.body': 'Windows and macOS (Apple Silicon) builds available now.',
      'download.trial_note': '📧 We\'ll only ask for your <strong>email</strong>. We\'ll then email you your <strong>trial license</strong> and a <strong>download link</strong> within 2 business days.',
    ...
    es: {
      ...
      'pricing.subscribe.step1': 'Instala AccuVideo y ábrelo. En el primer arranque la app te pide la licencia — si aún no tienes ninguna, usa los botones que aparecen dentro de la app para solicitar una <strong>prueba gratuita</strong> o una <strong>suscripción de pago</strong>. Sin copiar hardware ID ni bucear por menús.',
      'pricing.subscribe.step2': 'Pulsa <strong>Solicitar suscripción</strong> dentro de la app, o usa el <a href="#" data-open-form="subscribe">formulario de suscripción</a> de esta página. Elige <strong>plan</strong>, <strong>edición</strong> y <strong>periodo de facturación</strong> (mensual / anual) y te llevamos al checkout de Stripe. Cuando se confirma el pago, la primera vez te enviamos la licencia por email — tú la aplicas en la app en <strong>Ajustes</strong>. A partir de ahí, la licencia sigue siendo válida en esa máquina mientras la suscripción tenga el pago confirmado.',
      ...
      'download.trial_note': '📧 Sólo te pediremos tu <strong>email</strong>. Después te enviamos por email tu <strong>licencia trial</strong> y el <strong>enlace de descarga</strong> en hasta 2 días laborables.',
      'download.row_basic': 'Basic',
      'download.row_pro': 'Pro',
      'download.basic_win': 'Windows · .msi',
      'download.basic_mac': 'macOS Apple Silicon · .pkg',
  ...
  function bindSubscribeModal() {
    ...
    // and any link injected via i18n innerHTML (e.g. inside pricing.subscribe.step2).
    document.addEventListener('click', (e) => {
