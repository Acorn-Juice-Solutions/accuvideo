(function () {
  ...
  const i18n = {
    en: {
      ...
      'meta.description': 'Semantic search over your video library. Ask in plain language, jump to the exact second. 100% local, with optional GPU processing on compatible NVIDIA hardware.',
      ...
      'hero.lede': "AccuVideo searches your entire video library by what people say, what's on screen, and what's visible on camera — and lands you on the exact second. On compatible NVIDIA GPUs, optional GPU processing can speed up indexing and analysis while keeping everything local.",
      ...
      'features.sub': 'AccuVideo indexes every layer of your videos and lets you search across them in plain language, with optional GPU processing on compatible NVIDIA hardware.',
      ...
      'local.body': 'No cloud upload of your content. No subscription to read your own archive. Indexing, transcription, vision and search all run on your hardware, with optional GPU processing on compatible NVIDIA systems.',
      ...
      'editions.basic.f6': '<strong>Optional GPU processing</strong> — on compatible NVIDIA GPUs, Basic can speed up indexing and analysis while keeping everything local.',
      ...
      'editions.basic.cta_mac': 'macOS · .pkg',
      ...
      'editions.pro.f8': '<strong>GPU-accelerated build</strong> — separate <strong>.zip (&gt;2 GB)</strong> for faster processing on supported NVIDIA GPUs, with SHA-256 hash and release links.',
      ...
      'pricing.basic.starter.price_monthly_usd':     '13.99',
      'pricing.basic.starter.price_annual_usd':      '139.99',
      'pricing.basic.starter.price_monthly_pro_usd': '18.99',
      'pricing.basic.starter.price_annual_pro_usd':  '185.99',
      'pricing.basic.personal.price_monthly_usd':    '29.99',
      'pricing.basic.personal.price_annual_usd':     '299.90',
      'pricing.basic.personal.price_monthly_pro_usd':'39.99',
      'pricing.basic.personal.price_annual_pro_usd': '395.99',
      'pricing.basic.freelance.price_monthly_usd':   '64.99',
      'pricing.basic.freelance.price_annual_usd':    '628.99',
      'pricing.basic.freelance.price_monthly_pro_usd':'96.99',
      'pricing.basic.freelance.price_annual_pro_usd':'965.99',
      'pricing.pro.academy.price_monthly_usd':       '175.99',
      'pricing.pro.academy.price_annual_usd':        '1745.99',
      'pricing.pro.academy.price_monthly_pro_usd':   '262.99',
      'pricing.pro.academy.price_annual_pro_usd':    '2617.99',
      'pricing.pro.academyplus.price_monthly_usd':   '384.99',
      'pricing.pro.academyplus.price_annual_usd':    '3849.90',
      'pricing.pro.academyplus.price_monthly_pro_usd':'576.99',
      'pricing.pro.academyplus.price_annual_pro_usd':'5769.90',
      'pricing.pro.enterprise.price_monthly_usd':    '959.99',
      'pricing.pro.enterprise.price_annual_usd':     '9599.99',
      'pricing.pro.enterprise.price_monthly_pro_usd':'1439.99',
      'pricing.pro.enterprise.price_annual_pro_usd': '14399.90',
      ...
      'pricing.footnote_usd': 'Prices in USD. Annual billing available — contact us for a quote.',
      ...
      'pricing.license.notes': 'The trial runs for 30 days. When you\'re ready to subscribe, see below — paid plans are tied to your machine\'s hardware ID for security.',
      ...
      'download.trial_note': '📧 Before downloading, we\'ll only ask for your <strong>email</strong> — make sure it\'s correct. We\'ll send your trial license there. <strong>Then install the app; during the initial setup you\'ll be asked for the license — paste it when that step appears.</strong>',
      ...
      'req.sub': 'AccuVideo Basic runs on commodity laptops. Pro adds visual ingestion (Florence-2). Both editions support optional GPU processing on Windows with compatible NVIDIA cards — CPU remains the fallback when no GPU is available.',
      ...
      'req.min.gpu': 'GPU: integrated is enough. <strong>Optional GPU processing:</strong> if an NVIDIA GPU is detected, Basic can enable GPU mode and download the required bundled DLL pack on demand.',
      ...
      'contact.install_notice': '⚠️ <strong>Important — how to activate your trial:</strong><ol><li><strong>Install AccuVideo</strong> on your computer by running the <code>.msi</code> (Windows) or <code>.pkg</code> (macOS) you\'re about to download.</li><li>Open the app and go through the <strong>initial setup</strong> (files folder, models folder, port…) — one of the steps will ask for your license.</li><li>Paste the trial license we email you. Done.</li></ol>',
      ...
      'contact.autoresponse': 'Hi! We\'ve received your AccuVideo trial license request. We\'ll review it and email your 30-day trial license within a few hours.\n\nIf you don\'t hear back, please check your spam folder or write to us again.\n\n— The AccuVideo team',
      ...
      'thanks.body_trial': 'Your download should have started. We\'ll email your 30-day trial license within the next few hours — if you don\'t see it, check your spam folder. <strong>Remember:</strong> install AccuVideo first, then run the initial setup — one of its steps will ask you to paste the license.',
    ...
    es: {
      ...
      'editions.basic.f6': '<strong>Procesamiento por GPU opcional</strong> — en GPUs NVIDIA compatibles, Basic puede acelerar la indexación y el análisis manteniendo todo local.',
      ...
      'editions.pro.f8': '<strong>Build con GPU</strong> — <strong>.zip aparte (&gt;2 GB)</strong> para un procesamiento más rápido en GPUs NVIDIA compatibles, con hash SHA-256 y enlaces de release.',
      ...
      'pricing.pro.academyplus.price_annual_pro_usd':'5769,90',
      'pricing.pro.enterprise.price_monthly_usd':    '959,99',
      'pricing.pro.enterprise.price_annual_usd':     '9.599,99',
      'pricing.pro.enterprise.price_monthly_pro_usd':'1.439,99',
      'pricing.pro.enterprise.price_annual_pro_usd': '14.399,90',
      ...
      'pricing.footnote': 'Precios en EUR, IVA no incluido. Facturación anual disponible — escríbenos para presupuesto.',
      'pricing.footnote_usd': 'Precios en USD. Facturación anual disponible — escríbenos para presupuesto.',
      ...
      'pricing.license.notes': 'La trial dura 30 días. Cuando quieras suscribirte, mira más abajo — los planes de pago van ligados al hardware ID de tu equipo por seguridad.',
      ...
      'download.trial_note': '📧 Antes de descargar, solo te pediremos tu <strong>email</strong>; asegúrate de que sea correcto. Ahí te enviaremos tu licencia trial. <strong>Después instala la app; durante la configuración inicial se te pedirá la licencia — pégala cuando aparezca ese paso.</strong>',
      'download.row_basic': 'Basic',
      'download.row_pro': 'Pro',
      'download.basic_win': 'Windows · .msi',
      'download.basic_mac': 'macOS Apple Silicon · .pkg',
      ...
      'req.sub': 'AccuVideo Basic corre en portátiles normales. Pro añade ingesta visual (Florence-2). Ambas ediciones soportan procesamiento por GPU opcional en Windows con tarjetas NVIDIA compatibles — la CPU sigue siendo el respaldo si no hay GPU.',
      'req.min.title': 'Basic — audio + texto en pantalla',
      'req.min.cpu': 'CPU: Intel i5 (8.ª gen) / Ryzen 5 2600+ / Apple Silicon M1',
      'req.min.ram': 'RAM: 8 GB',
      'req.min.gpu': 'GPU: con la integrada basta. <strong>Procesamiento por GPU opcional:</strong> si se detecta una GPU NVIDIA, Basic puede activar el modo GPU y descargar bajo demanda el pack de DLLs necesario.',
      ...
      'contact.install_notice': '⚠️ <strong>Importante — cómo activar tu prueba:</strong><ol><li><strong>Instala AccuVideo</strong> en tu equipo ejecutando el <code>.msi</code> (Windows) o <code>.pkg</code> (macOS) que estás a punto de descargar.</li><li>Abre la aplicación y sigue la <strong>configuración inicial</strong> (carpeta de archivos, de modelos, puerto…) — uno de los pasos te pedirá la licencia.</li><li>Pega la licencia trial que te enviamos por email. Listo.</li></ol>',
      'contact.field.email': 'Email',
      'contact.field.plan': 'Plan',
      ...
      'contact.autoresponse': '¡Hola! Hemos recibido tu solicitud de licencia trial de AccuVideo. La revisaremos y te enviaremos tu licencia trial de 30 días en las próximas horas.\n\nSi no recibes respuesta, revisa la carpeta de spam o vuelve a escribirnos.\n\n— El equipo de AccuVideo',
      ...
      'thanks.body_trial': 'La descarga debería haber comenzado. Te enviaremos tu licencia trial de 30 días en las próximas horas — si no la ves en tu buzón, revisa la carpeta de spam o vuelve a escribirnos. <strong>Recuerda:</strong> primero instala AccuVideo y luego completa la configuración inicial — uno de sus pasos te pedirá que pegues la licencia.',
