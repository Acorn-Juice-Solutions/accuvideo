(function () {
  ...
  const i18n = {
    en: {
      ...
      'thanks.body_trial': 'Your download should have started. We\'ll email your 30-day trial license within the next few hours — if you don\'t see it, check your spam folder.',
    ...
    es: {
      ...
      'thanks.body_trial': 'La descarga debería haber comenzado. Te enviaremos tu licencia trial de 30 días en las próximas horas — si no la ves en tu buzón, revisa la carpeta de spam o vuelve a escribirnos.',
